...
urlpatterns = [
    ...
    path('flutter/edit', views.edit_rating_review_flutter, name='edit_rating_review_flutter'),
    path('flutter/delete', views.delete_rating_review_flutter, name='delete_rating_review_flutter'),
]
